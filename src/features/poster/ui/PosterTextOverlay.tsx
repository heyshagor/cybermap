  ...
  return (
    <div className="poster-text-overlay" style={{ color: textColor }}>
      ...
      {USE_LOGO_BADGES ? (
        <>
          <span
            className="poster-attribution-logo osm-badge"
            style={{
          ...
          >
            ...
            <span className="badge-label" style={{ fontSize: `calc(${attributionFontSize} * 0.55)` }}>
              {OSM_ATTRIBUTION_TEXT}
            </span>
          </span>
          {includeCredits && (
            <span
              className="poster-credits-logo app-badge"
              style={{
                bottom: `${TEXT_EDGE_MARGIN_RATIO * 100}%`,
