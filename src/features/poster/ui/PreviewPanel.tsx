...
const DEFAULT_LOCATION_LABEL = "Dhaka, Bangladesh";
...
export default function PreviewPanel() {
  ...
  const cityLabel = isCityCountryView
    ? form.displayCity || form.location || "Dhaka"
    : isCountryContinentView
      ? form.displayCountry || "Bangladesh"
  ...
  const handleRecenter = useCallback(() => {
    ...
    if (city && country) {
      ...
      applyTarget(city, country, continent || "Asia", label, true);
      return;
    }
    ...
    applyTarget(DEFAULT_CITY, DEFAULT_COUNTRY, "Asia", label, true);
      ...
      .then((resolved) => {
        ...
        dispatch({
          ...
          fields: {
            ...
            displayContinent:
              String(resolved.continent ?? "").trim() || "Asia",
          },
        });
      })
      .catch(() => {
